...
public:
  ...
  virtual void do_sweep_plus_node(xpl::sweep_plus_node * const node, int lvl) = 0;
	virtual void do_sweep_minus_node(xpl::sweep_minus_node * const node, int lvl) = 0;
  ...
  virtual void do_identidy_node(xpl::identidy_node * const node, int lvl) = 0;
